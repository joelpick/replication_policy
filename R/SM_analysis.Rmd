...
barplot(t(table(dd_scope$mult_pub,dd_scope$info_found))[2:1,], beside=TRUE, names.arg=c("1 journal", "2-5 journals", ">5 journals"), xlab="Publisher", ylab="Number of Journals")
